...
namespace EconomIA.Adapters.Persistence.Migrations
{
    ...
    [Migration("20260828120000_AdicionarIndiceNumeroControlePncpNaCompra")]
    partial class AdicionarIndiceNumeroControlePncpNaCompra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EconomIA.Domain.Compra", b =>
                {
                    ...
                    b.HasIndex("NumeroControlePncp")
                        .HasDatabaseName("ix_compra_NumeroControlePncp");

                    b.ToTable("compra", (string)null);
                });

            modelBuilder.Entity("EconomIA.Domain.ConfiguracaoCarga", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("CarregarAtas")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("carregar_atas");

                    b.Property<bool>("CarregarCompras")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("carregar_compras");

                    b.Property<bool>("CarregarContratos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("carregar_contratos");

                    b.Property<int>("DiaSemanasSincronizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("dia_semana_sincronizacao");

                    b.Property<int>("DiasCargaInicial")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(90)
                        .HasColumnName("dias_carga_inicial");

                    b.Property<int>("DiasRetroativos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                    ...
                    b.Property<TimeOnly>("HorarioSincronizacao")
                        .HasColumnType("time without time zone")
                        .HasColumnName("horario_sincronizacao");

                    b.Property<int>("MaxConcorrencia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(4)
                        .HasColumnName("max_concorrencia");

                    b.Property<string>("ModoCargaAutomatica")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                    ...
                    b.Property<bool>("SincronizarOrgaos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                    ...
                    b.HasKey("Id")
                        .HasName("pk_configuracao_carga");

                    b.ToTable("configuracao_carga", (string)null);
                });
            ...
            modelBuilder.Entity("EconomIA.Domain.Contrato", b =>
                {
                    ...
                    b.HasIndex("NumeroControlePncpCompra")
                        .HasDatabaseName("ix_contrato_NumeroControlePncpCompra");
            ...
            modelBuilder.Entity("EconomIA.Domain.ExecucaoCargaOrgao", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("AtasDuracaoMs")
                        .HasColumnType("bigint")
                        .HasColumnName("atas_duracao_ms");

                    b.Property<int>("AtasProcessadas")
                        .HasColumnType("integer")
                        .HasColumnName("atas_processadas");

                    b.Property<long>("ComprasDuracaoMs")
                        .HasColumnType("bigint")
                        .HasColumnName("compras_duracao_ms");

                    b.Property<int>("ComprasProcessadas")
                        .HasColumnType("integer")
                        .HasColumnName("compras_processadas");

                    b.Property<long>("ContratosDuracaoMs")
                        .HasColumnType("bigint")
                        .HasColumnName("contratos_duracao_ms");

                    b.Property<int>("ContratosProcessados")
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime?>("DataFinalProcessada")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("data_final_processada");

                    b.Property<DateTime?>("DataInicialProcessada")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<long>("IdentificadorDaExecucao")
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_execucao_carga_orgao");

                    b.HasIndex("IdentificadorDaExecucao")
                        .HasDatabaseName("ix_execucao_carga_orgao_IdentificadorDaExecucao");

                    b.HasIndex("IdentificadorDoOrgao")
                        .HasDatabaseName("ix_execucao_carga_orgao_IdentificadorDoOrgao");

                    b.ToTable("execucao_carga_orgao", (string)null);
                });
            ...
            modelBuilder.Entity("EconomIA.Domain.OrgaoMonitorado", b =>
                {
                    ...
                    b.HasIndex("IdentificadorDoOrgao")
                        .IsUnique()
                        .HasDatabaseName("un_orgao_monitorado_IdentificadorDoOrgao");
            ...
            modelBuilder.Entity("EconomIA.Domain.Usuario", b =>
                {
                    ...
                    b.HasIndex("IdentificadorExterno")
                        .IsUnique()
                        .HasDatabaseName("un_usuario_IdentificadorExterno");
            ...
            modelBuilder.Entity("EconomIA.Domain.ExecucaoCargaOrgao", b =>
                {
                    b.HasOne("EconomIA.Domain.ExecucaoCarga", "Execucao")
                        .WithMany("Orgaos")
                        .HasForeignKey("IdentificadorDaExecucao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_execucao_carga_orgao_IdentificadorDaExecucao_to_execucao_carga_Id");
                    ...
                    b.HasOne("EconomIA.Domain.Orgao", "Orgao")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_execucao_carga_orgao_IdentificadorDoOrgao_to_orgao_Id");
            ...
            modelBuilder.Entity("EconomIA.Domain.OrgaoMonitorado", b =>
                {
                    b.HasOne("EconomIA.Domain.Orgao", "Orgao")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_orgao_monitorado_IdentificadorDoOrgao_to_orgao_Id");
